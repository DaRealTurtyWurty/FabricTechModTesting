...
public class WindTurbineScreen extends AbstractContainerScreen<WindTurbineMenu> {
    private static final ResourceLocation TEXTURE = FabricTechModTesting.id("textures/gui/wind_turbine.png");
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (isHovering(36, 33, 21, 21, mouseX, mouseY)) {
            List<Component> tooltip = new ArrayList<>(List.of(
                    ...
                    Component.literal("Generation: %d%%".formatted((int) Mth.clamp(this.menu.getEnergyOutputPercent() * 100, 0, 100)))
            ));
